...
export default function PerawatPage() {
  return (
    <div className="space-y-6 animate-fade-in flex flex-col items-center justify-center min-h-[60vh] text-center">
      ...
      <h1 className="text-3xl font-extrabold text-neutral-900">Manajemen Perawat</h1>
      <p className="text-neutral-500 max-w-md">
        Halaman ini sedang dalam tahap pengembangan. Nantinya akan berisi daftar dan manajemen data seluruh perawat di RSUD Ngawi.
      </p>
